...
<div class="flex h-full flex-col gap-20">
	<div class="relative flex flex-row items-center justify-between">
		<a class="flex size-12 items-center justify-center rounded-lg bg-white" href="/" aria-label="Zurück zur Startseite">
			<ChevronLeft size={28} />
		</a>
		...
		<div class="flex flex-row items-center rounded-lg bg-white">
			<Dialog title="So funktioniert Impostor">
				{#snippet trigger()}
					<button class="flex size-12 items-center justify-center" type="button" aria-label="Spielregeln anzeigen">
				...
				<div class="flex flex-col gap-3 text-left text-black/70">
					...
					<p>Geheime Karten bleiben nur sichtbar, solange sie gedrückt gehalten werden.</p>
					<p>Nach allen Reveals startet die Diskussion mit einem zufälligen Startspieler.</p>
				</div>
			</Dialog>
